...
label remi:
    ...
    menu:
        ...
        "Accepter de lui parler en secret":
            ...
            $ AjouterACarac(vauban.Vauban.C_CHRISTIANISME, 4)
...
label vaast:
    ...
    $ niveauChrist = situation_.GetValCaracInt(vauban.Vauban.C_CHRISTIANISME)
    menu:
        ...
        "Vous lui parlez de votre intérêt pour le christianisme mais de votre doute sur la conversion" if niveauChrist > 7:
            ...
            $ AjouterACarac(vauban.Vauban.C_CHRISTIANISME, 2)
