...
label guerre_thuringie491:
    ...
    $ testCombat = testDeCarac.TestDeCarac([vauban.Vauban.C_MILITAIRE, metier.Stratege.NOM], puissanceArmeeChararic, situation_)
    ...
    label guerre_thuringie491_tonsurage:
        $ situation_.SetValCarac(vauban.Vauban.C_STATUT_CHARARIC, vauban.Vauban.CHARARIC_TONSURE)
    ...
    label guerre_thuringie491_vassalisation:
        ...
        $ AjouterACarac(vauban.Vauban.C_MILITAIRE, 1)
        $ AjouterACarac(vauban.Vauban.C_USURPATION, 2)
        $ situation_.SetValCarac(vauban.Vauban.C_STATUT_CHARARIC, vauban.Vauban.CHARARIC_VASSAL)
        jump fin_cycle
    ...
    label guerre_thuringie491_execution:
        ...
        $ situation_.SetValCarac(vauban.Vauban.C_STATUT_CHARARIC, vauban.Vauban.CHARARIC_MORT)
