...
label invasion_wisigoths1:
    ...
    $ valArmee = situation_.GetValCaracInt(vauban.Vauban.C_MILITAIRE)
    if valArmee < 2:
    ...
    label invasion_wisigoths1_ok:
        ...
        $ testCombat = testDeCarac.TestDeCarac([vauban.Vauban.C_MILITAIRE, metier.Stratege.NOM], 8, situation_)
        menu:
    ...
    label appel_divin_choix:
        ...
        menu:
            ...
            "Promettre au Dieu de Clothilde que vous vous convertirez si il vous apporte la victoire.":
                $ AjouterACarac(vauban.Vauban.C_CHRISTIANISME, 5)
                "A FAIRE"
    ...
    label victoire_bataille_tolbiac:
        ...
        menu:
            ...
            "Si vous recrutez parmi eux pour remplacer vos pertes.":
                ...
                $ AjouterACarac(vauban.Vauban.C_MILITAIRE, 2)
